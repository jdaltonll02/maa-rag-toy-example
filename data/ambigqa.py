...
"""
Preprocess the ambig_qa dataset to parquet format
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./ambig_qa")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    data_source = "sewon/ambig_qa"

    # dataset = datasets.load_dataset(data_source)

    train_dir = "./ambig_qa/ambigqa_train_questions_and_answers.json"
    test_dir = "./ambig_qa/ambigqa_test_questions_and_answers.json"
