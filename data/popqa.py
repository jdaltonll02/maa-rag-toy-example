...
"""
Preprocess the pop qa to parquet format
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./pop_qa")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    data_source = "akariasai/PopQA"

    # dataset = datasets.load_dataset(data_source)
    # dataset = dataset['test']

    test_dir = "./pop_qa/popqa_test_questions_and_answers.json"
