...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./2wikimultihop_qa")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    data_source = "voidful/2WikiMultihopQA"

    # dataset = datasets.load_dataset(data_source)

    train_dir = "./2wikimultihop_qa/2wikimultihop_train_questions_and_answers.json"
    test_dir = "./2wikimultihop_qa/2wikimultihop_test_questions_and_answers.json"
