...
if __name__ == "__main__":
    ...
    data_source = "google-research-datasets/nq_open"
    ...
    train_dir = "./nq/nq_train_questions_and_answers.json"
    test_dir = "./nq/nq_test_questions_and_answers.json"

    with open(train_dir, 'r', encoding='utf-8') as f:
        train_dataset = json.load(f)[-996:]
    ...
    # train_dataset.to_json(os.path.join(local_dir, "train_distill.jsonl"))
    test_dataset.to_json(os.path.join(local_dir, "test_996.jsonl"))

    # train_dataset.to_parquet(os.path.join(local_dir, "train_distill.parquet"))
